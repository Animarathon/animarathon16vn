...
label set_vivid_dreams:

    menu:

        a "My dreams tend to be..."
...
label set_haunted:
    ...
    menu:
        ...
        system "Select your level of spooky."

        "Less then 1 Spooky":

            system "Most spooks have been disabled."
        ...
        "1 Spooky":
            ...
            system "One spooky has been enabled."
        ...
        "2 Spooky":
            ...
            # You know what? If I have to ask all these questions I don't think people are actually gonna believe it's true.
            # I'm cutting hijacking nearby 2D Printers, 3D Printers, Wi-Fi, CD-Drives, and EMI radio transmissions from the game.

            menu:

                system "Warning: This level of spooky may affect {b}the real world{/b}."

                "That's OK, and I'm taking this seriously.":

                    menu:

                        system "Warning: This level of spooky may permanently damage your computer hardware and yourself."

                        "I accept full responsibility for breaking my computer":

                            menu:

                                system "Warning: This level of spooky may cause fires in improperly configured equipment nearby."

                                "I accept full responsibility for any fires I make":

                                    return

                                "That's too spooky, go back.":
